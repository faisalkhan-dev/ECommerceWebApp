...
import com.project.ecom.entity.*;
...
public class MainController {
    ...
    public String index(Model model) {
        ...
        try {
            ...
            model.addAttribute("listProducts", Collections.emptyList());
            model.addAttribute("error", "No products available at the moment.");
            // Render the homepage with an empty product list and error message
        }
        return "index";
    }
...
//                model.addAttribute("error", cause.getCause().getMessage());
//            } else if (cause != null) {
